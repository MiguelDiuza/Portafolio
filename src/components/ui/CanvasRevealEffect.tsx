...
/**
 * Fondo de matriz de puntos animada (shader GLSL sobre three.js).
 * Adaptado del componente sign-in-flow-1 — se usa SOLO como fondo
 * de la sección de aterrizaje de las SkillCards.
 */
export const CanvasRevealEffect = ({
  ...
  return (
    <div
      className={cn("canvas-reveal-root", containerClassName)}
